...
<div class="card-body">
        ...
        <div class="col-md-5">
            <select name="id_kategori" class="form-control">
                <?php foreach ($kategori as $kategori) { ?>
                    <option value="<?php echo $kategori->id_kategori ?>" <?php if ($produk->id_produk == $kategori->id_kategori) {
                                                                                echo "selected";
                                                                            } ?>>
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <input type="ukuran" name="ukuran" class="form-control" placeholder="Ukuran Produk" value="<?php echo $produk->ukuran ?>" required>
        </div>
    </div>
